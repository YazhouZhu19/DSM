    ...
    def __init__(self, replace_stride_with_dilation=None, pretrained_weights='resnet101'):
        ...
        if pretrained_weights == 'deeplabv3':
            self.pretrained_weights = torch.load(
                "/media/cs4007/79768867-4da1-4a94-b85b-bed307b913ed/zyz/DSM/checkpoints/deeplabv3_resnet101_coco-586e9e4e.pth", map_location='cpu')
        elif pretrained_weights == 'resnet101':
            self.pretrained_weights = torch.load("/media/cs4007/79768867-4da1-4a94-b85b-bed307b913ed/zyz/DSM/checkpoints/resnet101-63fe2227.pth",
                                                 map_location='cpu')
        else:
...
class Res50Encoder(nn.Module):
    ...
    def __init__(self, replace_stride_with_dilation=None, pretrained_weights='resnet50'):
        ...
        if pretrained_weights == 'deeplabv3':
            self.pretrained_weights = torch.load(
                "/media/cs4007/79768867-4da1-4a94-b85b-bed307b913ed/zyz/DSM/checkpoints/deeplabv3_resnet50_coco-cd0a2569.pth", map_location='cpu')  # pretrained on COCO
        elif pretrained_weights == 'resnet50':
            self.pretrained_weights = torch.load("/media/cs4007/79768867-4da1-4a94-b85b-bed307b913ed/zyz/DSM/checkpoints/resnet50-19c8e357.pth",

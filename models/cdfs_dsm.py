...
class FewShotSeg(nn.Module):
    """
    Few-shot Segmentation Model with DSM Enhancement
    
    Main pipeline: Original BATE-based approach (primary)
    Enhancement: DSM modules - SFR and DSIS (secondary/auxiliary)
    """

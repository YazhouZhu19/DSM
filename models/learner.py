...
class MixedLearner(nn.Module):
    def __init__(self, inch):
        super(MixedLearner, self).__init__()
    ...
    def forward(self, hypercorr_pyramid):
        ...
        """
        hypercorr_pyramid[0]: (1, 1, 8, 8, 8, 8)
        hypercorr_pyramid[1]: (1, 3, 16, 16, 16, 16)
        hypercorr_pyramid[2]: (1, 3, 32, 32, 32, 32)
        """
